...
const ensurePanel = () => {
  ...
  stagePanel.className = "smash-embed-panel";

  frameContainer = document.createElement("div");
  frameContainer.className = "smash-embed-frame-wrap";
...
const mountIframe = () => {
  ...
  nextFrame.className = "smash-embed-frame";
  nextFrame.title = "Smash / Pass classic mode";
