  ...
  return (
    <SonnerToaster
      ...
      toastOptions={{
        classNames: {
          toast:
            "group pointer-events-auto flex w-full max-w-md items-start gap-3 rounded-xl border border-border bg-background px-4 py-3 text-foreground shadow-lg backdrop-blur",
